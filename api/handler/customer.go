...
func (h Handler) UpdateCustomer(c *gin.Context) {
    ...
    if err != nil {
        handlerResponseLog(c, h.Log, "error while validating customer id", http.StatusBadRequest, err.Error())
        return
    }
    ...
    if err != nil {
        handlerResponseLog(c, h.Log, "error while updating customer", http.StatusInternalServerError, err.Error())
        return
    }
